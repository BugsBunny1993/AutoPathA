...
void game::load_map(){
    ...
    AutoPathA *path_finder=AutoPathA::alloc();
    path_finder->init(labyrinth->getLayerSize(), this);
    path_finder->setFindPoints(ccp(1, 18), ccp(32, 18));
}
...
bool game::AutoPathAIsEmpty(CCPoint grid_point){
...
void game::AutoPathAdidFindPath(CCArray* path,bool secussed){
